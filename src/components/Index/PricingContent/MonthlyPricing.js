...
const MonthlyPricing = ({ tActive }) => {
	// console.log(tActive);
	return (
		<div className={`tab-pane fade show ${tActive}`} id="monthly-tab-pane">
